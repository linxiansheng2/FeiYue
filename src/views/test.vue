...
const upColor = '#24AA71';
const downColor = '#E65D44';
...
const setData = [dataMA5,dataMA10,dataMA20];
const setName = ['MA5','MA10','MA20'];
option.series && (function(){
    for (let index = 0; index < 3; index++) {
     (option.series instanceof Array) && option.series.push({
        name: setName[index],
        type: 'line',
        xAxisIndex: 1,
        yAxisIndex: 1,
